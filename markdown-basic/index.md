...
If you want to know about the extented Markdown syntax of **DoIt** theme, please read [extended Markdown syntax page](https://hugodoit.pages.dev/theme-documentation-content/#extended-markdown-syntax).
{{< /admonition >}}
...
{{< admonition tip >}}
**DoIt** theme has [special shortcode for image](https://hugodoit.pages.dev/theme-documentation-extended-shortcodes/#image), which provides more features.
{{< /admonition >}}
